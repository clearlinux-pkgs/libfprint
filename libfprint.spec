...
Version  : 1.94.8
Release  : 5
URL      : https://gitlab.freedesktop.org/libfprint/libfprint/-/archive/v1.94.8/libfprint-v1.94.8.tar.gz
Source0  : https://gitlab.freedesktop.org/libfprint/libfprint/-/archive/v1.94.8/libfprint-v1.94.8.tar.gz
...
%prep
%setup -q -n libfprint-v1.94.8
cd %{_builddir}/libfprint-v1.94.8
pushd ..
cp -a libfprint-v1.94.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725472351
