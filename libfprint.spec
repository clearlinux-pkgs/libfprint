...
%prep
%setup -q -n libfprint-v1.90.2
cd %{_builddir}/libfprint-v1.90.2
...
cp %{_builddir}/libfprint-v1.90.2/COPYING %{buildroot}/usr/share/package-licenses/libfprint/caeb68c46fa36651acf592771d09de7937926bb3
