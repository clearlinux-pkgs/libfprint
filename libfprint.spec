...
Source0  : https://gitlab.freedesktop.org/libfprint/libfprint/-/archive/v1.94.7/libfprint-v1.94.7.tar.gz
...
%prep
%setup -q -n libfprint-v1.94.7
cd %{_builddir}/libfprint-v1.94.7
pushd ..
cp -a libfprint-v1.94.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708461973
